...
(function (global, factory) {
    ...
    */
    ...
    var SummerNoteUploadFileButton = function (context) {
        ...
        var button = ui.button({
            ...
            click: function () {
                ...
                if ($('#summerNoteUploadFile').length == 0) {
                    $('<input>').attr({
                        type: 'file',
                        id: 'summerNoteUploadFile',
                        name: 'summerNoteUploadFile'
                    }).appendTo('body');

                    $('#summerNoteUploadFile').css("display", "none");
                }
                $('#summerNoteUploadFile').on('change', function (e) {
                    var summerNoteUploadedFile = document.getElementById("summerNoteUploadFile").files[0];

                    // var urlOfSummerNoteUploadedFile = sendFile(summerNoteUploadedFile);

                    var data = new FormData();
                    data.append("file", summerNoteUploadedFile);
                    ...
                    $.ajax({
                        ...
                        success: function (url) {
                            ...
                            context.invoke('editor.pasteHTML', "<a href='" + url + "'>" + selectedText + "</a>");
                            HoldOn.close();
                        },
    ...
    $$1.summernote = $$1.extend($$1.summernote, {
        ...
        options: {
            ...
            buttons: { uploadfile: SummerNoteUploadFileButton },
            lang: 'en-US',
            ...
            fontSizes: ['8', '9', '10', '11', '12', '14', '16', '18', '20', '22', '24', '28', '36', '48', '72', '82', '150'],
